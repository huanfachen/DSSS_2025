...
<a href="https://colab.research.google.com/github/huanfachen/DSSS_25/blob/main/sessions/W06_neural_networks/graph_neural_networks_practical.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>

# Part 1: Implementing GCN in PyTorch Geometric
...
**We will be using it for predicting the class to which a given paper belongs**

## Working

Most of the working is same as for the PyTorch version, except that we will be using an adjacency list representation instead of adjacency matrix. Advantage of using adjacency list is that all the edges can be stored in $O(|E|)$ where $|E|$ is the number of edges, whereas in adjacency matrix it is $O(|V|^2)$ where $|V|$ is number of vertices. So if the number of edges is much less than the number of vertices squared then adjacency list can save a lot of memory and time.
...
![Formula](graph_nets/GCN/img/formula.png)
...
![Zachary Karate Club](graph_nets/GraphSAGE/img/karate_club.png)
...
![Simple Graph](graph_nets/GraphSAGE/img/example_graph_1.png)
...
![Mean Embeddings](graph_nets/GraphSAGE/img/animation.gif)

This is a straightforward idea, which can be generalized by representing it in the following way:

![Simple Neighbours](graph_nets/GraphSAGE/img/simple_neighbours.png)
...
![One Layer Aggregation](graph_nets/GraphSAGE/img/aggregation_1.png)
...
![Animation Aggregation Layer 1](graph_nets/GraphSAGE/img/animation_2_bw.gif)

So after one iteration, the values are as follows:

![Second Layer Aggregation](graph_nets/GraphSAGE/img/aggregation_2.png)

Repeating the same procedure on this new graph, we get (try verifying yourself):

![Third Layer Aggregation](graph_nets/GraphSAGE/img/aggregation_3.png)
...
![Sampling](graph_nets/GraphSAGE/img/showing_1.png)
...
![Sampling 2](graph_nets/GraphSAGE/img/showing_2.png)
...
![GraphSAGE Algorithm](graph_nets/GraphSAGE/img/graphsage_algorithm.png)
...
![Loss](graph_nets/GraphSAGE/img/Loss_function.png)
...
![Mean Aggregator](graph_nets/GraphSAGE/img/ma.png)
...
![Pool Aggregator](graph_nets/GraphSAGE/img/pa.png)
...
![Sharing Parameters](graph_nets/GraphSAGE/img/sharing_param.png)
...
![Protein Interaction](graph_nets/GraphSAGE/img/protein.png)
...
![New Node](graph_nets/GraphSAGE/img/new_node.png)
