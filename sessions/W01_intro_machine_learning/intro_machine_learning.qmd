...
:::: {.column width="50%"}
::: {style="text-align:center;"}
<img src="images/amazon2.png" alt="Amazon product page" style="max-width:60%;"/>
:::
::::
::::::
...
:::: {.column width="50%"}
::: {style="text-align:center;"}
<img src="images/exoplanet.png" alt="Exoplanet" style="max-width:50%;"/>
:::
::::
::::::
...
::: {style="text-align:center;"}
<img src="images/LOAC.jpg" alt="Reinforcement learning cycle" style="max-width:80%;"/>
:::
...
::: {style="text-align:center;"}
<img src="images/Anomaly_detection_techniques.jpg" alt="Reinforcement learning cycle" style="max-width:80%;"/>
...
::: {style="text-align:center;"}
<img src="images/forecasting.png" alt="Reinforcement learning cycle" style="max-width:80%;"/>
  <div style="font-size:0.8em; color: #555; margin-top:4px;">
...
::: {style="text-align:center;"}
<img src="images/amazon_explanations.png" alt="Amazon explanations" style="max-width:50%;"/>
:::
