...
<div style="text-align:center;">
  <img src="images/precision_recall.webp" alt="precision vs recall" style="max-width:60%;">
  <div style="font-size:0.8em; color: #555; margin-top:4px;">
...
- Model #2 has higher predictive power (including precision & recall) than #1 and #3.
