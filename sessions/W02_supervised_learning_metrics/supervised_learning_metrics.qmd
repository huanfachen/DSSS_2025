...
- To generate this plot: 
  ...
  2. With a given classification **threshold**, predict label=1 if p(label=1) > threshold; else predict label=0, then compute precision & recall.
  3. Vary the threshold from 0 to 1, compute precision and recall at each threshold. Link the dots to get the curve.
