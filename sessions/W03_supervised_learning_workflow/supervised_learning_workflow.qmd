...
<div style="text-align:center;">
  <img src="images/knn_boundary_k3.png" alt="KNN boundary k=3" style="max-width:40%;">
</div>
...
<div style="text-align:center;">
  <img src="images/knn_boundary_varying_k.png" alt="KNN boundary varying k" style="max-width:40%;">
</div>

## Model Complexity

<div style="text-align:center;">
  <img src="images/knn_model_complexity.png" alt="KNN model complexity" style="max-width:60%;">
</div>
...
- Good for choosing k
- [But the testing accuray is overly optimistic and biased]{style="color:blue"}
...
<div style="text-align:center;">
  <img src="images/overfitting_validation_set_1.png" alt="Overfitting validation 1" style="max-width:65%;">
</div>
