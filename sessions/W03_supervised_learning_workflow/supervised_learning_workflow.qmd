...
1. Train-test split
2. Threefold split (train-validation-test)
...
- Good for choosing k
- [But, overly optimistic for generalisation]{style="color:blue"}
...
<div style="text-align:center;">
  <img src="images/knn_model_complexity_marked.png" alt="Train-test split" style="max-width:60%;">
</div>
...
- Train → Validation (tune hyperparams) → Test (final eval)

## Why? overfitting the Validation Set
...
<div style="text-align:center;">
  <img src="images/kfold_cv.png" alt="KFold CV" style="max-width:90%;">
</div>
...
- [RepeatedKFold]{style="color:blue;"}: multiple shuffled KFold runs
...
## Standard CV not preserving class distribution
...
## Scenario 1: To predict new data from existing cities (i.i.d.)
