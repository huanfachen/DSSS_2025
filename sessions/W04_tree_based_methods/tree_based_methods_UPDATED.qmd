...
- Kaggle example: predict outdoor *badminton playability* based on *weather conditions*

:::: columns

::: {.column width="50%"}

- **Y**: playability (Yes, No)
...
::: {.column width="50%"}
<div style="text-align:center;">
  <img src="images/images/outdoor_badminton.jpg" alt="Tree building step 2" style="max-width:30%;">
</div>
:::
...
** Add a classification tree, with regions **

## A classification tree: making prediction

- A leaf node may contain samples of multiple classes.
- A leaf node can predict the probability distribution of classes AND the major class.
...
## A classifcation tree: making prediction
