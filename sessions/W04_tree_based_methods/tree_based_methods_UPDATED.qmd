...
- Many types of decision trees: **classification and regression trees (CART)**, C4.5, ID3, CHAID, etc. These trees (except CART) are rarely used these days.
- Focus on CART: binary trees for classification and regression
- A CART is a regression tree when the target variable *Y* is continous, and a classification tree when *Y* is categorical. It is not dependent on type of features (*X*).
- 
...
- A dataset with two numertical features (X[0], [1]), to predict *Y* with two classes (<span style="color: red;">RED</span> and <span style="color: blue;">BLUE</span>)
- Two visuals: tree structure, decision boundary
- The *leaf node* and *region* are one-to-one mapped.
- a node with *counts=[40, 30]* means this node contains 40 <span style="color: red;">RED</span> samples, 30 <span style="color: blue;">BLUE</span> samples.

<div style="text-align:center;">
  <img src="images/tree_depth_2.png" alt="tree_demonstration_depth_2" style="max-width:30%;">
</div>
...
- The leaf node D has *counts=[1, 10]*, so it predicts <span style="color: blue;">BLUE</span> class AND probability distribution of [1/11, 10/11] over two classes.

<div style="text-align:center;">
  <img src="images/tree_depth_2_making_prediction.png" alt="tree_demonstration_depth_2_making_prediction" style="max-width:30%;">
</div>
...
- *Note:* a split is **a X feature** and **a threshold**. 
- *Note #2:* can't split on *Y*, as *Y* is unknown for new datasets.
- *Note #3:* can't split on multiple *X* variables.
...
<div style="text-align:center;">
  <img src="images/tree_depth_2_impurity_reduction.png" alt="tree_depth_2_impurity_reduction" style="max-width:30%;">
</div>
...
<div style="text-align:center;">
  <img src="images/tree_depth_2_impurity_reduction_comparison.png" alt="tree_depth_2_impurity_reduction_comparison" style="max-width:30%;">
</div>
...
- For classification: Gini (by default), or Cross-Entropy
- For regression: Mean Square Error (by default), or Mean Absolute Error
...
<div style="text-align:center;">
  <img src="images/oob_estimates.png" alt="OOB estimates" style="max-width:50%;">
</div>
