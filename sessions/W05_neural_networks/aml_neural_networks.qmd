...
<div style="text-align:center;">
  <img src="aml-18-neural-networks/images/log_reg_nn.png" alt="Logistic regression as neural net" style="max-width:40%;">
</div>

## Basic Architecture

<div style="text-align:center;">
  <img src="aml-18-neural-networks/images/nn_basic_arch.png" alt="Basic neural network architecture" style="max-width:50%;">
</div>
...
<div style="text-align:center;">
  <img src="aml-18-neural-networks/images/nn_manylayers.png" alt="Neural network with many layers" style="max-width:60%;">
</div>
...
<div style="text-align:center;">
  <img src="aml-18-neural-networks/images/nonlin_fn.png" alt="Nonlinear activation functions" style="max-width:65%;">
</div>
...
<div style="text-align:center;">
  <img src="aml-18-neural-networks/images/backprop_eqn.png" alt="Backpropagation equations" style="max-width:70%;">
</div>
...
<div style="text-align:center;">
  <img src="aml-18-neural-networks/images/relu_differentiability.png" alt="ReLU differentiability" style="max-width:75%;">
</div>
...
<div style="text-align:center;">
  <img src="aml-18-neural-networks/images/nn_sklearn.png" alt="Neural nets with sklearn" style="max-width:45%;">
</div>
...
<div style="text-align:center;">
  <img src="aml-18-neural-networks/images/random_state.png" alt="Effect of random state" style="max-width:75%;">
</div>
...
<div style="text-align:center;">
  <img src="aml-18-neural-networks/images/hidden_layer_size.png" alt="Hidden layer size effect" style="max-width:50%;">
</div>
...
<div style="text-align:center;">
  <img src="aml-18-neural-networks/images/hidden_layer_size_2.png" alt="Multiple hidden layers" style="max-width:48%;">
</div>
...
<div style="text-align:center;">
  <img src="aml-18-neural-networks/images/activation_functions_plot.png" alt="Activation functions" style="max-width:45%;">
</div>
...
<div style="text-align:center;">
  <img src="aml-18-neural-networks/images/regression_plot.png" alt="Neural network regression" style="max-width:55%;">
</div>
...
<div style="text-align:center;">
  <img src="aml-18-neural-networks/images/gridsearch_plot.png" alt="Grid search results" style="max-width:45%;">
</div>
...
<div style="text-align:center;">
  <img src="aml-18-neural-networks/images/search_hidden_layers_plot.png" alt="Search hidden layer sizes" style="max-width:40%;">
</div>
...
<div style="text-align:center;">
  <img src="aml-18-neural-networks/images/gpu_support.png" alt="GPU performance" style="max-width:55%;">
</div>
...
<div style="text-align:center;">
  <img src="aml-18-neural-networks/images/computation_graph.png" alt="Computation graph" style="max-width:35%;">
</div>
...
<div style="text-align:center;">
  <img src="aml-18-neural-networks/images/tensor_flow_basics.png" alt="TensorFlow basics" style="max-width:75%;">
</div>
