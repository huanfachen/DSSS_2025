...
For the difference between tensors and ndarrays, see [tensors documentation](https://www.tensorflow.org/guide/tensor#tensors-vs-numpy-arrays) and [the geeksforgeeks post](https://www.geeksforgeeks.org/deep-learning/pytorch-tensor-vs-numpy-array/). I found the latter one more interesting and easier to understand.
...
More info on MNIST can be found [here](http://yann.lecun.com/exdb/mnist/).
