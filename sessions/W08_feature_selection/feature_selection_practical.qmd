...
- Understand how to apply mutual information and permutation importance for feature selection of supervised learning models.
...
MI measures non-linear dependency between each predictor and target. We compute MI on the prepared matrix and then use `SelectFromModel` (with precomputed importances) to keep 20 features.
...
# RFECV for random forest features (20 features)
...
1. Compare the overlap among MI, PI, and RFECV feature subsets.
2. Change random forest hyperparameters and observe whether selected subsets still perform similarly.
3. Test whether combining two selectors (e.g. MI + RFECV intersection) improves generalisation.
