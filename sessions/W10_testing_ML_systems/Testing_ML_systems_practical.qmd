...
Testing in ML is about testing the **code and system behavior**, rather than train-test split on the dataset.
...
```bash
!python3 -m pytest tests/ --cov=firepredict --cov-report=html --cov-report=term-missing --cov-omit=firepredict/main.py -v
```
