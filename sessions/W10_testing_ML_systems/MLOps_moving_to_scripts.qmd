...
2. Refactor code into functions (and classes)
...
<div style="text-align:center;">
  <img src="images/pipeline.png" alt="Sklearn Pipeline" style="max-width:80%;">
  <div style="font-size:0.8em; color: #555; margin-top:4px;">
