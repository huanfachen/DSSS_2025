...
- Steps (repeated until balanced)
  1. Randomly pick up a minority sample, find its k nearest minority neighbors based on features
  2. Randomly select one neighbor and create a synthetic sample by **interpolating** between the two samples
...
<div style="text-align:center;">
  <img src="images/SMOTE.gif" style="max-width:100%;">
</div>
